...
/** Returns the keystring used as client_id in the OAuth flow. */
...
/**
 * Builds headers for every Etsy API request.
 * x-api-key must be "keystring:shared_secret" combined.
 * Authorization must be "Bearer {oauth_access_token}".
 */
