...
export default function IntelligenceError({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => { console.error("[IntelligenceError]", error); }, [error]);

  return (
    <div style={{ padding: "3rem", textAlign: "center" }}>
      <h2 style={{ color: "var(--text-primary)", marginBottom: "0.75rem" }}>Intelligence scan failed</h2>
